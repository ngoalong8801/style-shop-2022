...
<div class="row" style="margin-top: 20px;">
	<div class="col-md-12 table-responsive">
		<h3>Add account</h3>
		<a href="http://localhost/style-shop-2022/UserAdmin" class="btn btn-outline-primary">Back to User list</a>
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h5 style="color: red;"></h5>
			</div>
			<div class="panel-body">
				<form method="post" action="http://localhost/style-shop-2022/UserAdmin/PostAdd/">
