...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="http://localhost/style-shop-2022/public/images/favicon.png">
    <!-- Main Style CSS -->
    <link rel="stylesheet" href="http://localhost/style-shop-2022/public/css/style.css">
    <!-- Fontawesome -->
...
<body>
    ...
    <nav id="navColor" class=" navbar fixed-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand my-2 my-md-1" href="http://localhost/style-shop-2022/Home">
            <img src="https://raw.githubusercontent.com/PhucNguyen1905/SPhone/main/public/images/sphone.png" alt="logo-school">
            <span class="h2 mb-0 fw-bold text-warning">BK Shop</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item <?php if ($data["render"] != "tintuc" && $data["render"] != "gioithieu" && $data["render"] != "contact") echo "active"; ?>">
                    <a class="nav-link text-warning fw-bold" href="http://localhost/style-shop-2022/Home">Trang chủ <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link text-warning fw-bold dropdown-toggle" href="http://localhost/style-shop-2022/Home/productList" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Sản phẩm
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link text-warning fw-bold dropdown-item" href="http://localhost/style-shop-2022/Home/productList/0">Tất cả</a>
                        <?php
                        $countCategory = count($data["allCategory"]);
                        for ($i = 0; $i < $countCategory; $i++) {
                            echo   '<a class="text-warning fw-bold dropdown-item" href="http://localhost/style-shop-2022/Home/productList/' . $data["allCategory"][$i]["id"] . '">' . $data["allCategory"][$i]["name"] . '</a>';
                        }
            ...
            <form class="form-inline my-2 my-lg-0" method="POST" action="http://localhost/style-shop-2022/Home/search_buttuon">
