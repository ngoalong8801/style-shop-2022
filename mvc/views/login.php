...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Shop/public/css/login.css">
    <title>Login</title>
</head>

<body>

    <form id="form_login" action="http://localhost/Shop/Login/UserLogin" method="post">
        <h4>ĐĂNG NHẬP</h4>
        ...
        ?>
        <div>
            <a id="link_register" href="http://localhost/Shop/Register">Đăng ký tài khoản</a>
