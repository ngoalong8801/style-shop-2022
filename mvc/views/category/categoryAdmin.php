				...
				<tbody>
					...
					for ($i = 0; $i < $countCategory; $i++) { ?>
						<tr>
							...
							<td><a href="<?php echo 'http://localhost/style-shop-2022/CategoryAdmin/ViewEdit/' . $data["category"][$i]["id"]; ?>" class="editLink">Edit</a></td>
							<td><a href="<?php echo 'http://localhost/style-shop-2022/CategoryAdmin/Delete/' . $data["category"][$i]["id"]; ?>" class="delLink" style="color: #ff7782;">Delete</a></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
...
<script>
	...
	jQuery(".delLink").on("click", function(e) {
		...
		var msg = confirm("Bạn có chắc chắn rằng muốn xoá Category này?");
		if (msg == true) {
