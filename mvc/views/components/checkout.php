...
<nav id="nav-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="ml125 breadcrumb-item"><a href="http://localhost//Home">Trang chủ</a></li>
  ...
  <div class="pt-4 pb-3">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        ...
        <!-- Grid row -->
        <form method="POST" action="http://localhost/style-shop-2022/OrderAdmin/addOrderSuccess">
          <div class="row">
            <!-- Grid column -->
            <div class="col-lg-12">
