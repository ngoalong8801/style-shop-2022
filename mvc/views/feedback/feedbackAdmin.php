		...
		<table class="table table-bordered table-hover" style="margin-top: 20px;">
			...
			<tbody>
				...
				for ($i = 0; $i < $countFeedback; $i++) {
					...
					<td>' . $data["allFeedback"][$i]['phone'] . '</td>
					...
					if ($data["allFeedback"][$i]['status'] == 0) {
						echo '<a href="http://localhost/style-shop-2022/Feedback/updateStatusFeedback/' . $data["allFeedback"][$i]['id'] . '"><button class="btn btn-primary">Đã Đọc</button><a/>';
					}
					echo '</td>
				</tr>';
				}
