...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/Shop/public/css/register.css">
  <title>Register</title>
</head>

<body>

  <form id="form_register" action="http://localhost/Shop/Register/UserRegister" method="post">
    ...
    <div>
      <a id="link_login" href="http://localhost/Shop/Login">Tôi đã có tài khoản</a>
      <button type="submit" onclick="checkRegister()" name="btnRegister" class="btn btn-primary">Đăng ký</button>
      <a id="link_register" href="http://localhost/Shop/Home">Trở về trang chủ</a>
    </div>
