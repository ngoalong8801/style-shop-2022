...
if ($user != null) {
  if ($user["role_id"] == 1) {
    ...
    header('Location: http://localhost/style-shop-2022/admin');
  }
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/style-shop-2022/public/css/register.css">
  <title>Register</title>
</head>

<body>

  <form id="form_register" action="http://localhost/style-shop-2022/Register/UserRegister" method="post">
    ...
    <div class="md-form md-outline mt-0">
      ...
      <input name="email" id="form19" class="form-control" placeholder="Email">
    </div>
    <?php
    ...
    <div>
      <a id="link_login" href="http://localhost/style-shop-2022/Login">Tôi đã có tài khoản</a>
      <button type="submit" onclick="checkRegister()" name="btnRegister" class="btn btn-primary">Đăng ký</button>
      <a id="link_register" href="http://localhost/style-shop-2022/Home">Trở về trang chủ</a>
    </div>
